...
// this will be for observing the life cycle of the app
{
  ...
  // Adding observer for handling the instance of audioPlayer according to the applifecycle
  @override
  ...
  // One can also create an api which will return JSON data related to the songs
  ...
  // These are the songs and there details which I'll will be using in our app
